  ...
  .command(
    ...
    (yargs) => {
      ...
      yargs.option('addon', {
        type: 'boolean',
        alias: 'a',
        description: 'when present, addon-mode is used, which opts in to ember-try + a different default ember-cli-build.js. In this mode, many other flags are disabled.',
        default: false,
      });
